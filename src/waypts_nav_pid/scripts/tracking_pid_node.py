...
class TrackingPID:
    def __init__(self):
        ...
        self.pub_cmd_vel = rospy.Publisher("/cmd_vel_1", Twist, queue_size=1)
        # Data
        self.twist = Twist()
    ...
    def param_callback(self, config, _):
        ...
        print("lin: ", self.pid_angular.kp, self.pid_angular.ki , self.pid_angular.kd ,
                     self.pid_angular.min_integral, self.pid_angular.max_integral, self.pid_angular.min_output,
                      self.pid_angular.max_output, self.pid_angular.delta) 
